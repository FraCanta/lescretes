...
const HeroHome2 = ({ img, title }) => {
  return (
    <>
      <div className=" w-full flex-col justify-center flex  py-[50px] md:py-[80px] 3xl:py-0 lg:h-screen ">
        <h1 className=" w-[90%] mx-auto  text-main font-black text-4xl  md:text-5xl xl:text-6xl 3xl:text-8xl">
          {title}
        </h1>
