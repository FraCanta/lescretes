...
const HeroHome2 = ({ img, title }) => {
  return (
    <>
      <div className="w-[90%] flex-col justify-center gap-[28.8px] flex mx-auto py-[25px] lg:py-[80px]">
        <h1 className="w-full lg:w-[85%]  text-main font-black text-[32.64px] lg:text-[60px] leading-[42.4px] lg:leading-[65px]">
          {title}
        </h1>
