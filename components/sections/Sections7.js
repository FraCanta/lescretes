...
const Sections7 = () => {
  ...
  return (
    <>
      <div className="w-[90%] mx-auto min-h-[80vh] h-full relative grid grid-cols-1 2xl:grid-cols-2 py-[48px] 2xl:py-0 gap-10 2xl:gap-0 items-center">
        <div className="flex flex-col h-full justify-center gap-8 ">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-[16px] lg:text-[20px] text-main font-medium w-full 2xl:w-[60%]">
