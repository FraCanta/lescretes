    ...
    <>
      <div className="w-[90%] mx-auto relative py-[50px] lg:p-[120px] z-[9999]">
        <div className="inline-flex flex-col items-center justify-start w-full h-full gap-10 py-10">
          <h2 className="w-full  2xl:w-full 2xla:w-11/12  fxl:w-[65%] 3xl:text-7xl  lg:text-center text-white text-4xl md:text-5xl lg:text-5xl fxl:text-[60px] font-bold ">
            {translation?.title}
          </h2>
          <p className="lg:w-[60%] xl:w-[80%] fxl:w-[60%] 3xl:w-[75%] lg:text-center text-white/80 text-lg md:text-xl  fxl:text-2xl 3xl:text-4xl 3xl:leading-normal font-light">
