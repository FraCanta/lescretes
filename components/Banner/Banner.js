...
const Banner = ({ img, title, paragraph, btn1, btn2, link1, link2 }) => {
  return (
    <div className="w-full min-h-screen md:min-h-[70vh] lg:h-full fxl:min-h-[60vh]  py-[48px] xl:py-0  bg-main flex flex-wrap  items-center relative">
      <div className="grid grid-cols-1 xl:grid-cols-2 w-[90%] mx-auto items-center justify-center h-full gap-10">
