...
export default function Home({ translation }) {
  return (
    <>
      ...
      <div className="min-h-[calc(100vh_-_60px)] md:min-h-[calc(100vh_-_60px)] fxl:min-h-[calc(100vh_-_100px)] 3xl:min-h-[calc(100vh_-_180px)] w-full hero  relative flex text-end items-end">
