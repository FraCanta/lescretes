    ...
    <>
            ...
            >
              ...
              {el.descrizione.map((d, i) => {
                return (
                  <div
                    key={i}
                    className=" text-main text-xl md:text-2xl 2xl:text-xl fxl:text-2xl 3xl:text-4xl 3xl:leading-normal font-normal flex flex-col gap-10"
                  >
      ...
      <div className="w-full min-h-[40vh] flex flex-col justify-center bg-second   bg-pattern">
        <div className="w-[90%] h-full  mx-auto flex flex-col gap-4 md:gap-8 justify-center ">
          ...
          <ul className="flex flex-col gap-2 text-main text-xl md:text-2xl xl:text-xl 3xl:text-3xl font-normal fxl:text-2xl">
